sap.ui.define([
	...
	"use strict";
	return Controller.extend("valoremapp.ValoremAppHTML.controller.Koba.OtrosKobaMm", {
		onInit: function () {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this.getView());
            this.oRouter.getRoute("OtrosKobaMm").attachMatched(this._onRouteMatched, this);
		},
