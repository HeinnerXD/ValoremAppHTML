sap.ui.define([
	...
	"use strict";
	return Controller.extend("valoremapp.ValoremAppHTML.controller.GenerarConcepto", {
		onInit: function () {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this.getView());
            this.oRouter.getRoute("GenerarConcepto").attachMatched(this._onRouteMatched, this);
		},
		...
		handlePressConfiguration: function () {
			...
			that.oRouter.navTo("InformesCaracol",{roles: JSON.stringify(this.arr)}, true);
		},
...
// CAMBIOS EN CONTROLADOR PARA UPLOAD DE ARCHIVOS
