sap.ui.define([
	...
	return Controller.extend("valoremapp.ValoremAppHTML.controller.InformesValorem", {

		onInit: function () {
            this.oRouter = sap.ui.core.UIComponent.getRouterFor(this.getView());
            this.oRouter.getRoute("InformesValorem").attachMatched(this._onRouteMatched, this);
        },
