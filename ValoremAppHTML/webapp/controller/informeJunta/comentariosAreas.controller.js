sap.ui.define([
    ...
    "use strict";
    return Controller.extend("valoremapp.ValoremAppHTML.controller.informeJunta.comentariosAreas", {
        onInit: function () {
            this.oRouter = sap.ui.core.UIComponent.getRouterFor(this.getView());
            this.oRouter.getRoute("comentariosAreas").attachMatched(this._onRouteMatched, this);
        },
        ...
        onDowload: function (filename) {
            ...
            $.post(urlServer + "/api/downloadFile", {
                ...
                url: "03. INFORME DE JUNTA/PRODUCCION/03. Comentarios por Area/3.1. Comentarios",
                fileName: filename
            }).done(function (data) {
                console.log(data)
