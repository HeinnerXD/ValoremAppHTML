sap.ui.define([
    ...
    "use strict";
    return Controller.extend("valoremapp.ValoremAppHTML.controller.informeJunta.comentariosGenerales", {
        onInit: function () {
            this.oRouter = sap.ui.core.UIComponent.getRouterFor(this.getView());
            this.oRouter.getRoute("comentariosGenerales").attachMatched(this._onRouteMatched, this);
        },
        ...
        onDowload: function (filename) {
            ...
            $.post(urlServer + "/api/downloadFile", {
                ...
                url: "03. INFORME DE JUNTA/PRODUCCION/04. Detalle Comentarios/4.1. Comentarios",
                fileName: filename
            }).done(function (data) {
                window.open(url + '/' + filename);
                jQuery.sap.delayedCall(650, this, function () {
                    $.post(urlServer + "/api/cleanServer").done(function (response) {
