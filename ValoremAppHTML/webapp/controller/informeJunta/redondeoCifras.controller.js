sap.ui.define([
    ...
    "use strict";
    return Controller.extend("valoremapp.ValoremAppHTML.controller.informeJunta.redondeoCifras", {
        onInit: function () {
            this.oRouter = sap.ui.core.UIComponent.getRouterFor(this.getView());
            this.oRouter.getRoute("redondeoCifras").attachMatched(this._onRouteMatched, this);
        },
        ...
        onDowload: function (filename) {
            ...
            $.post(urlServer + "/api/downloadFile", {
                ...
                url: "03. INFORME DE JUNTA/PRODUCCION/05. Redondeo de Cifras/5.1. Redondeo",
                fileName: filename
            }).done(function (data) {
                console.log(data)
