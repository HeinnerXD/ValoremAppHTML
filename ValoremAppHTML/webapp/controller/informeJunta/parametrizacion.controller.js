sap.ui.define([
	...
	"use strict";
	return Controller.extend("valoremapp.ValoremAppHTML.controller.informeJunta.parametrizacion", {
		onInit: function () {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this.getView());
            this.oRouter.getRoute("parametrizacion").attachMatched(this._onRouteMatched, this);
		},
        ...
        onDowload: function (filename) {
            ...
            $.post(urlServer + "/api/downloadFile", {
                ...
                url: "03. INFORME DE JUNTA/PRODUCCION/06. Parametrización/6.1. Mantenimiento",
                fileName: filename
            }).done(function (data) {
